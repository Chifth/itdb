	...
	oTable = $('#itemlisttbl').dataTable( {
		...
		"aoColumnDefs": [
			{ "sWidth": "60px", "aTargets":  [ 0 ] },
                        ...
                        { "sWidth": "120px", "aTargets": [ 2 ] },//��ǩ
                        { "sWidth": "100px", "aTargets": [ 3 ] },//IP��ַ
                        { "sWidth": "150px", "aTargets": [ 4 ] },//����
                        { "sWidth": "60px", "aTargets":  [ 5 ] },//�û�
                        { "sWidth": "200px", "aTargets": [ 6 ] },//�û�
                        { "sWidth": "50px", "aTargets":  [ 7 ] },//״̬
			{ "sWidth": "120px", "aTargets": [ 8 ] },//�ͺ�
                        { "sWidth": "200px", "aTargets": [ 9 ] }//�ʲ����
		],
		"order": [[ 3, 'asc' ]],
		"bProcessing": true,
		"bServerSide": true,
